...
class AutoRegisterAccount():
    ...
    def page_has_loaded(self):
        ...
        return True
    def AccountRegite(self,name,emailaddr,phonenumber):
        ...
        self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/section[1]/div[1]/div[1]/form[1]/div[2]/div[2]/input[1]").send_keys(emailaddr)
        ...
        print("Complete")
    def AccountVerify(self,emailaddr,password):
        try:
...
class AutoLogIn():
    def __init__(self):
        ...
        self.chrome_options = Options()
        self.exe_path = "drivers/chromedriver"
        self.username = "asdf@asdf.com"
        self.password = "asdfsadf"
        pass
    def LogIn(self,emailaddr,emailpassword):
        self.driver = webdriver.Chrome(chrome_options=self.chrome_options, executable_path=self.exe_path)
        self.driver.get('https://algeria.blsspainvisa.com/')
        self.driver.find_element(By.XPATH,"//div[@class='popupCloseIcon']").click()
        ...
        MailAddr = 'devtest0316@outlook.com'
        ...
        self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[2]/input[1]").send_keys(emailaddr);
        self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/input[2]").click();
        sleep(2);
        self.driver.implicitly_wait(2);
        OTPcode = self.get_otp_from_email(emailaddr,emailpassword)
        ...
        self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/div[2]/input[1]").send_keys(emailpassword)
        self.driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/section[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[3]/input[2]").click();

        self.check_isOpen()
    def get_otp_from_email(self,mailAddr,mailPass):
            mail = outlook.Outlook()
            mail.login(mailAddr,mailPass)
            mail.inbox()
            mailText = mail.mailbody()
            mail.logout()
            return self.find_opt(mailText)
...
if __name__ == "__main__":
    ...
    logBot.LogIn('devtest0316@outlook.com','xf21?lb6')
